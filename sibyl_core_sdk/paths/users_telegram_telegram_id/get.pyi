...
# Path params
TelegramIdSchema = schemas.StrSchema
RequestRequiredPathParams = typing_extensions.TypedDict(
    'RequestRequiredPathParams',
    {
        'telegram_id': typing.Union[TelegramIdSchema, str, ],
    }
)
...
request_path_telegram_id = api_client.PathParameter(
    name="telegram_id",
    style=api_client.ParameterStyle.SIMPLE,
    schema=TelegramIdSchema,
    required=True,
)
...
class BaseApi(api_client.Api):
    @typing.overload
    def _users_telegram_telegram_id_get_oapg(
        self,
...
class UsersTelegramTelegramIdGet(BaseApi):
    ...
    def users_telegram_telegram_id_get(
        ...
        return self._users_telegram_telegram_id_get_oapg(
